...
<body>
    ...
    <!-- MENU BAR -->
    <nav class="navbar navbar-expand-lg" style="background-color: #088a08;">
        <div class="container">
    ...
    <section class="hero bg-gli d-flex justify-content-center align-items-center">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 d-flex flex-column justify-content-center align-items-center">
                    <div class="hero-text">
                        ...
                        <h1 class="text-white" data-aos="fade-up" data-aos-delay="100" style="margin-left: 50px; font-weight: bold;">
                            Welcome to Green Leadership Indonesia
                        </h1>
                ...
                <div class="col-lg-6 col-12">
                    <div class="hero-image" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <img src="{{asset('img/green-leader/hero-gli-main.png')}}" class="img-fluid" alt="working girl">
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-5 col-12">
                    <div class="contact-image" data-aos="fade-up">
                        ...
                        <img src="{{asset('img/portfolio/gli2.JPG')}}" class="img-fluid rounded" alt="website">
                    </div>
                </div>
                ...
                <div class="col-lg-12 col-12">
                    ...
                    <div class="owl-carousel owl-theme" id="project-slide">
                        <div class="item project-wrapper" data-aos="fade-up" data-aos-delay="100">
                            <img src="{{asset('img/civic-edu/narsum/1.png')}}" class="img-fluid" alt="project image">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 mx-lg-auto col-md-8 col-10">
                    ...
                    <h2 class="text-white" data-aos="fade-up" data-aos-delay="100"><strong>Green Leadership Indonesia</strong></h2>
                </div>
